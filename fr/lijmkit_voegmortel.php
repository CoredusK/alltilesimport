...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
	...
	<div id="main">
		<div class="fullwidth">
			<h1>ATI Mortier de Jointoyage</h1>
			<small>Clicquez la photo pour enlargir</small>
			<a href="images/voeg_lijm/ati_voeg_fr.jpg" target="_blank">
				<img src="images/voeg_lijm/ati_voeg_fr.jpg" class="bigimg" /></a><br/>
			
			<a href="images/voeg_lijm/verbruikstabel.jpg" name="verbruik" target="_blank">
				<img src="images/voeg_lijm/verbruikstabel.jpg"/></a>
						
			<br/><br/>
			<h1>Calculateur de consommation ATI Mortier de jointoyage</h1>
			<small>Entrer tous les valeurs en cm svp</small></br></br>
			<table>
			...
			if($engaged){
				if(is_numeric($l) && is_numeric($b) && is_numeric($vb) && is_numeric($vd)){
					...
					echo '<font size="4"><b>Consommation: ' . round($result,2) . ' kg/m²</b></font>';
				}
				else echo '<font color="red"><b>Erreur! Entrer seulement des numéros svp</b></font>';
			...
			<a href="assets/download/ati_voegmortel.pdf" target="_blank">
				Clicquez ici pour le manual (neerlandais).</a><br/><br/>
		</div>	<div></div><div></div>
		...
		<div class="fullwidth">
			...
			<a href="assets/download/ati_lijmkit.pdf" target="_blank">Clicquez ici pour notre PDF (neerlandais).</a><br/><br/><br/><br/>
		</div>

...
&& isset($_POST["regpw"]) && $_POST["regpw"] != "" && $codeok) {
	...
	if(!$exists) {
		...
		if ($con->query($q) === TRUE) {
		    ...
		    $errmsg = "Registratie succesvol! U kan nu inloggen";
		    $errmsgcolor = "#78AF2C";
		} else {
...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
	...
	<div id="main">
		...
		<div class="doublecolumn" style="margin-top:20px;">
			...
			Email:<br/><br/><input type="email" name="regmail" tabindex="1" value="<?php echo htmlentities($email); ?>"><br/><br/>
			Wachtwoord:<br/><br/><input type="password" name="regpw" tabindex="2" value="<?php echo htmlentities($pass); ?>"><br/><br/>
			Code:<br/><br/><input type="text" name="code" tabindex="3" value="<?php echo htmlentities($code); ?>"><br/><br/>
